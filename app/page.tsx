export default function Home() {
  return (
    ...
    >
      ...
      >
        <p style={{ margin: 0 }}>
          currently an engineer in fintech at @ visa. Interested in stablecoin and agentic payment modalities. Interested in pursuing research in various artificial 
